  ...
  return (
    <>
      ...
      >
        ...
        <div className="px-4">
          <h4 className="font-medium text-lg xl:text-itemtitle2 text-black hover:text-primary dark:hover:text-primary dark:text-white mt-7.5">
            <Link href={`/blog/blog-details${_id !== 1 ? _id : ''}`}>
              {title}
            </Link>
          </h4>
